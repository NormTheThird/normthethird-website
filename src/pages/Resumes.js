    ...
    <Layout>
      <div className="mi-skills-area mi-section mi-padding-top">
        <div className="container">
          ...
          <div className="mt-30">
            <p>Knowledgeable in: Azure, AWS, ASP.Net MVC, WPF MVVM, VB.Net, Entity Framework, LINQ, NUnit, Moq, TFS, Git, FoxPro</p>
            <p>Experience in: Angular, Python, Ruby, Jenkins, PostgreSQL, MySQL</p>
          </div>      
        </div>
      </div>
